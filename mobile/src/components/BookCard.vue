...
<template>
  ...
  >
    ...
    <!-- Cover Placeholder: Minimalist Modern -->
    <view class="w-16 h-22 bg-stone-100 rounded-xl flex flex-col items-center justify-end pb-3 shrink-0 relative overflow-hidden shadow-inner">
