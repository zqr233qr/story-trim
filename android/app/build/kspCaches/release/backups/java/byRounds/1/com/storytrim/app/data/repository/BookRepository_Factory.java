...
public final class BookRepository_Factory implements Factory<BookRepository> {
  ...
  private final Provider<TrimmedContentDao> trimmedContentDaoProvider;
  ...
  public BookRepository_Factory(Provider<ApiClient> apiClientProvider,
      ...
      Provider<TrimmedContentDao> trimmedContentDaoProvider,
    ...
    this.trimmedContentDaoProvider = trimmedContentDaoProvider;
  ...
  public BookRepository get() {
    return newInstance(apiClientProvider.get(), bookServiceProvider.get(), trimServiceProvider.get(), bookDaoProvider.get(), chapterDaoProvider.get(), contentDaoProvider.get(), trimmedContentDaoProvider.get(), fileParserProvider.get(), appDatabaseProvider.get(), zipUtilsProvider.get(), contextProvider.get());
  }
  ...
  public static BookRepository_Factory create(Provider<ApiClient> apiClientProvider,
      ...
      Provider<FileParser> fileParserProvider, Provider<AppDatabase> appDatabaseProvider,
      Provider<ZipUtils> zipUtilsProvider, Provider<Context> contextProvider) {
    return new BookRepository_Factory(apiClientProvider, bookServiceProvider, trimServiceProvider, bookDaoProvider, chapterDaoProvider, contentDaoProvider, trimmedContentDaoProvider, fileParserProvider, appDatabaseProvider, zipUtilsProvider, contextProvider);
  }
  ...
  public static BookRepository newInstance(ApiClient apiClient, BookService bookService,
      ...
      TrimmedContentDao trimmedContentDao, FileParser fileParser, AppDatabase appDatabase,
      ZipUtils zipUtils, Context context) {
    return new BookRepository(apiClient, bookService, trimService, bookDao, chapterDao, contentDao, trimmedContentDao, fileParser, appDatabase, zipUtils, context);
  }
}
