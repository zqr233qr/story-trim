...
import com.storytrim.app.core.database.dao.TrimmedContentDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  private volatile TrimmedContentDao _trimmedContentDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `trimmed_contents` (`book_id` INTEGER NOT NULL, `chapter_id` INTEGER NOT NULL, `prompt_id` INTEGER NOT NULL, `content` TEXT NOT NULL, `created_at` INTEGER NOT NULL, PRIMARY KEY(`book_id`, `chapter_id`, `prompt_id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '04c1bfa4aeec18f50ca91805df0e8c89')");
      }
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS `trimmed_contents`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsTrimmedContents = new HashMap<String, TableInfo.Column>(5);
        _columnsTrimmedContents.put("book_id", new TableInfo.Column("book_id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrimmedContents.put("chapter_id", new TableInfo.Column("chapter_id", "INTEGER", true, 2, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrimmedContents.put("prompt_id", new TableInfo.Column("prompt_id", "INTEGER", true, 3, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrimmedContents.put("content", new TableInfo.Column("content", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrimmedContents.put("created_at", new TableInfo.Column("created_at", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysTrimmedContents = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesTrimmedContents = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoTrimmedContents = new TableInfo("trimmed_contents", _columnsTrimmedContents, _foreignKeysTrimmedContents, _indicesTrimmedContents);
        final TableInfo _existingTrimmedContents = TableInfo.read(db, "trimmed_contents");
        if (!_infoTrimmedContents.equals(_existingTrimmedContents)) {
          return new RoomOpenHelper.ValidationResult(false, "trimmed_contents(com.storytrim.app.core.database.entity.TrimmedContentEntity).\n"
                  + " Expected:\n" + _infoTrimmedContents + "\n"
                  + " Found:\n" + _existingTrimmedContents);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "04c1bfa4aeec18f50ca91805df0e8c89", "490bfa380fdfbf4cf2bc33b750474418");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "books","chapters","contents","reading_history","trimmed_contents");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `trimmed_contents`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(TrimmedContentDao.class, TrimmedContentDao_Impl.getRequiredConverters());
  ...
  @Override
  public TrimmedContentDao trimmedContentDao() {
    if (_trimmedContentDao != null) {
      return _trimmedContentDao;
    } else {
      synchronized(this) {
        if(_trimmedContentDao == null) {
          _trimmedContentDao = new TrimmedContentDao_Impl(this);
        }
        return _trimmedContentDao;
      }
    }
